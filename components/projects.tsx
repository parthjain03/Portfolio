  ...
  const projects = [
    {
      ...
      detailedDescription: 'Project AgniAstra was thrustMIT\'s flagship entry to the Spaceport America Cup 2024, designed for the 30,000 ft COTS category with a design velocity of Mach 1.83. As Team Leader and Structural Design Engineer, I directed the complete development of the rocket, overseeing structural architecture, composite fabrication, subsystem integration, and recovery system design.||AgniAstra featured the team\'s first-ever dual-bay recovery system and a pressure-based separation mechanism, marking a significant step forward in thrustMIT\'s systems capability. I also contributed to the development of a CO₂-based deployment concept explored during the design phase.||The rocket reached Mach 1.7 and an apogee of 17,010 ft, becoming India\'s first student-built supersonic rocket. Our team ranked 1st in Asia in the 30k COTS category and 7th worldwide in the Project Technical Report domain. The project combined analytical modelling with ANSYS-based verification, rigorous subsystem coordination, and full-scale mission execution.',
      reports: [
    ...
    {
      id: 3,
      title: 'Airbus Sloshing Rocket Workshop',
      description: 'Workshop participation focused on liquid propellant sloshing dynamics and mitigation strategies.',
      year: '2024',
      technologies: ['Liquid Propulsion', 'Sloshing Dynamics', 'CFD', 'Aerospace Engineering'],
      detailedDescription: 'Participated in specialized workshop on liquid propellant sloshing phenomena in rocket tanks and its effects on vehicle stability and control.',
      reports: [],
      videos: [],
      photos: []
    },
